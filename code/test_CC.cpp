...
//    inv_rho_mask1.dimension(theDensityMap.density.u1() , theDensityMap.density.u2() , theDensityMap.density.u3());
    ...
    vector<float> originx(3,0.0);
    vector<float> origin;
    originx[0] = theDensityMap.origin[0];
    originx[1] = theDensityMap.origin[1];
    originx[2] = theDensityMap.origin[2];
    MatrixTimesTransVector(theDensityMap.f2c,originx,origin);
    vector<float> gridx(3,0);
    gridx[0] = (float)theDensityMap.grid[0];
    gridx[1] = (float)theDensityMap.grid[1];
    gridx[2] = (float)theDensityMap.grid[2];
    vector<float> grid;
    MatrixTimesTransVector(theDensityMap.f2c,gridx,grid);
...
//            MatrixTimesTransVector(theDensityMap.c2f,cartX1,fracX1);
            ...
            atm_idx[tmp_i][0] = pos_mod (double(cartX1[0]*grid[0] - origin[0] + 1) , (double)grid[0]);
            atm_idx[tmp_i][1] = pos_mod (double(cartX1[1]*grid[1] - origin[1] + 1) , (double)grid[1]);
            atm_idx[tmp_i][2] = pos_mod (double(cartX1[2]*grid[2] - origin[2] + 1) , (double)grid[2]);   
