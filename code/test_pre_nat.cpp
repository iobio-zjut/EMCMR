...
//            cartX1[2] = cartX1[2] - theDensityMap.origin[2];
            ...
            atm_idx[tmp_i][0] = (double(fracX1[0]*theDensityMap.grid[0] - theDensityMap.origin[0] + 1) );
            atm_idx[tmp_i][1] = (double(fracX1[1]*theDensityMap.grid[1] - theDensityMap.origin[1] + 1) );
            atm_idx[tmp_i][2] = (double(fracX1[2]*theDensityMap.grid[2] - theDensityMap.origin[2] + 1) );              
...
//    mass_mrc[0] = float(theDensityMap.grid[0]+1.0)/2.0 + (theDensityMap.origin[0]);
//    mass_mrc[1] = float(theDensityMap.grid[1]+1.0)/2.0 + (theDensityMap.origin[1]);
//    mass_mrc[2] = float(theDensityMap.grid[2]+1.0)/2.0 + (theDensityMap.origin[2]);
//     mass_mrc[0] = pos_mod (double(mass_mrc[0] ) , (double)theDensityMap.grid[0]);
//     mass_mrc[1] = pos_mod (double(mass_mrc[1] ) , (double)theDensityMap.grid[1]);
//     mass_mrc[2] = pos_mod (double(mass_mrc[2] ) , (double)theDensityMap.grid[2]);
     mass_mrc[0] = (double(mass_mrc[0] )/(double)theDensityMap.grid[0]);
     mass_mrc[1] = (double(mass_mrc[1] )/(double)theDensityMap.grid[1]);
     mass_mrc[2] = (double(mass_mrc[2] )/(double)theDensityMap.grid[2]);
    vector<float> fracX_mrc;
    MatrixTimesTransVector(theDensityMap.f2c,(mass_mrc),fracX_mrc);
//    mass_mrc[0] = fracX_mrc[0]*theDensityMap.grid[0];
//    mass_mrc[1] = fracX_mrc[1]*theDensityMap.grid[1];
//    mass_mrc[2] = fracX_mrc[2]*theDensityMap.grid[2];
//    mass_mrc[0] = mass_mrc[0] + (theDensityMap.origin[0]);
//    mass_mrc[1] = mass_mrc[1] + (theDensityMap.origin[1]);
//    mass_mrc[2] = mass_mrc[2] + (theDensityMap.origin[2]);     
...
//    cout<<"mass_mrc0: "<<mass_mrc0[0]<<" "<<mass_mrc0[1]<<" "<<mass_mrc0[2]<<endl;
    ...
    frac_atm[0] = (double(frax_pdb[0]*theDensityMap.grid[0] - theDensityMap.origin[0] + 1));
    frac_atm[1] = (double(frax_pdb[1]*theDensityMap.grid[1] - theDensityMap.origin[1] + 1));
    frac_atm[2] = (double(frax_pdb[2]*theDensityMap.grid[2] - theDensityMap.origin[2] + 1));     
//    frac_atm[0] = pos_mod (double(frax_pdb[0]*theDensityMap.grid[0] - theDensityMap.origin[0] + 1) , (double)theDensityMap.grid[0]);
//    frac_atm[1] = pos_mod (double(frax_pdb[1]*theDensityMap.grid[1] - theDensityMap.origin[1] + 1) , (double)theDensityMap.grid[1]);
//    frac_atm[2] = pos_mod (double(frax_pdb[2]*theDensityMap.grid[2] - theDensityMap.origin[2] + 1) , (double)theDensityMap.grid[2]);
    vector<float> del_tran(3,0.0);
    del_tran[2] =(frac_atm[2]-float(theDensityMap.grid[2])/2.0)/float(theDensityMap.grid[2]);
    del_tran[1] =(frac_atm[1]-float(theDensityMap.grid[1])/2.0)/float(theDensityMap.grid[1]);
    del_tran[0] =(frac_atm[0]-float(theDensityMap.grid[0])/2.0)/float(theDensityMap.grid[0]);
    vector<float> tran0;
...
//            cartX1[2] = cartX1[2] - theDensityMap.origin[2];                     
            ...
            atm_idxt[0] = (double(fracX1[0]*theDensityMap.grid[0] - theDensityMap.origin[0] + 1) );
            atm_idxt[1] = (double(fracX1[1]*theDensityMap.grid[1] - theDensityMap.origin[1] + 1) );
            atm_idxt[2] = (double(fracX1[2]*theDensityMap.grid[2] - theDensityMap.origin[2] + 1) ); 
//            atm_idxt[0] = pos_mod (double(fracX1[0]*theDensityMap.grid[0] - theDensityMap.origin[0] + 1) , (double)theDensityMap.grid[0]);
//            atm_idxt[1] = pos_mod (double(fracX1[1]*theDensityMap.grid[1] - theDensityMap.origin[1] + 1) , (double)theDensityMap.grid[1]);
//            atm_idxt[2] = pos_mod (double(fracX1[2]*theDensityMap.grid[2] - theDensityMap.origin[2] + 1) , (double)theDensityMap.grid[2]);                
    //        atm_idx[tmp_i][0] = fracX1[0]*theDensityMap.grid[0] - theDensityMap.origin[0] + 1 ;
    //        atm_idx[tmp_i][1] = fracX1[1]*theDensityMap.grid[1] - theDensityMap.origin[1] + 1 ;
    //        atm_idx[tmp_i][2] = fracX1[2]*theDensityMap.grid[2] - theDensityMap.origin[2] + 1 ;
    //        cout<<"RRRR: "<<atm_idx[tmp_i][0]<<" "<<atm_idx[tmp_i][1]<<" "<<atm_idx[tmp_i][2]<<endl; 
...
//  readPDB
    ...
    readpdbstructurex(inputPDB2,posey);
...
//          cout<< pnum<<endl;      
    ...
    int pnumy=0;
    for(int i=0;i<posey.chains.size();i++)
    {
//      cout<< "chainx size: "<<posex.chains.size()<<endl;
//      cout<< "chainy size: "<<posey.chains.size()<<endl;
        Chain Chanx = posey.chains[i];
//      Chain Chany = posey.chains[i];
        for(int j=0;j<Chanx.residues.size();j++)
        {
//          cout<< "residuex size: "<< Chanx.residues.size()<<endl;
...
//          cout<< pnum<<endl;      
    ...
    {
        cout<<inputPDB1<<endl;
        cout<<"pnum,pnumy: "<<pnum<<" "<<pnumy<<endl;
    } 
...
// /opt/rh/devtoolset-7/root/usr/bin/g++ test_translation_3.cpp CaDensityx_test.cpp SplineInterp.cpp GeometryTools.cpp readpdb.cpp GetVdwRadius.cpp xray_scattering.cpp Rotbuilder.cpp randomx.cpp -o UseDensityx4 -I/nfs/amino-home/zbiao/LibC/tt/CaDensity -L/nfs/amino-home/zbiao/LibC/tt/CaDensity/fourier -lfourierx -O3