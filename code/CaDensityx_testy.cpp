...
//		numeric::xyzVector<core::Real> fracX = c2f*(this->origin);
		...
		forigin[0]=  altorigin[0];
		forigin[1]=  altorigin[1];
		forigin[2]=  altorigin[2];
...
//		this->origin = numeric::xyzVector<core::Real>( fracX[0]*grid[0] , fracX[1]*grid[1] , fracX[2]*grid[2] );
		this->origin[0] = fracX[0]*grid[xyz2crs[0]];
		this->origin[1] = fracX[1]*grid[xyz2crs[1]];
		this->origin[2] = fracX[2]*grid[xyz2crs[2]];
...
//		numeric::xyzVector<core::Real> fracX = c2f*(this->origin);
		...
		MatrixTimesTransVector(c2f,(forigin),fracX);
//		this->origin = numeric::xyzVector<core::Real>( fracX[0]*grid[0] , fracX[1]*grid[1] , fracX[2]*grid[2] );
		newOri[0] = fracX[0]*newDims[0];
		newOri[1] = fracX[1]*newDims[1];
		newOri[2] = fracX[2]*newDims[2];
